...
def editar_produto_view(id):
    produtos = produtos_controller.obter_produto(id)
    categorias = categoria_controller.listar_todas_categorias()
...
def listar_usuarios_view():
    usuarios = usuarios_controller.listar_usuario()
    return render_template("usuarios/listar.html", usuarios= usuarios)

@web_bp.route("/usuario/novo", methods=["POST", "GET"])
...
@web_bp.route("/usuario/editar/<int:id>", methods=["POST", "GET"])
